...
import com.appspot.cafesanu_gae.conference.model.Conference;
import com.appspot.cafesanu_gae.conference.model.ConferenceCollection;
import com.appspot.cafesanu_gae.conference.model.Profile;
import com.appspot.cafesanu_gae.conference.model.WrappedBoolean;
...
public class ConferenceUtils {
    ...
    private static com.appspot.cafesanu_gae.conference.Conference sApiServiceHandler;
    ...
    public static List<DecoratedConference> getConferences()
        ...
        com.appspot.cafesanu_gae.conference.Conference.QueryConferences
    ...
    public static boolean registerForConference(Conference conference)
        ...
        com.appspot.cafesanu_gae.conference.Conference.RegisterForConference
    ...
    public static boolean unregisterFromConference(Conference conference)
        ...
        com.appspot.cafesanu_gae.conference.Conference.UnregisterFromConference
    ...
    public static Profile getProfile() throws ConferenceException, IOException {
        ...
        com.appspot.cafesanu_gae.conference.Conference.GetProfile getProfile =
                sApiServiceHandler.getProfile();
        return getProfile.execute();
    }

    /**
     * Build and returns an instance of {@link com.appspot.cafesanu_gae.conference.Conference}
     *
     * @param context
     * @param email
     * @return
     */
    public static com.appspot.cafesanu_gae.conference.Conference buildServiceHandler(
            Context context, String email) {
        GoogleAccountCredential credential = GoogleAccountCredential.usingAudience(
                context, AppConstants.AUDIENCE);
        credential.setSelectedAccountName(email);

        com.appspot.cafesanu_gae.conference.Conference.Builder builder
                = new com.appspot.cafesanu_gae.conference.Conference.Builder(
